...
public class ShakingObject : MonoBehaviour{
    ...
    [SerializeField] private float shakeDuration = 10f; // Tiempo l�mite para que caiga si no lo sostiene el gato
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        } else if (other.CompareTag("Player") && isShaking)
        {
            ...
            {
                StopCoroutine(shakeCoroutine); // Detenemos la ca�da mientras el gato sostiene
            }
    ...
    private void OnTriggerExit2D(Collider2D other)
    {
        if (other.CompareTag("Player") && catIsHolding)
        {
            ...
            // Reiniciamos el temporizador de ca�da si a�n est� temblando
    ...
    private IEnumerator ShakeTimer()
    {
        ...
        anim.SetInteger("ObjectStatus", 2); // Estado de ca�da
